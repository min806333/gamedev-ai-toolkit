...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      {resolvedTheme === "dark" ? <SunMedium className="h-4 w-4 shrink-0" /> : <Moon className="h-4 w-4 shrink-0" />}
      <span className="break-keep">{resolvedTheme === "dark" ? t.common.light : t.common.dark}</span>
    </button>
  );
}
