...
const en = {
  ...
  dashboard: {
    ...
    idea: "Idea Generator",
    ui: "UI Generator",
    pixelPrompt: "Pixel Art Prompt Generator",
    code: "Code Generator",
    unity: "Unity Scripts",
    gdd: "GDD Generator",
    ...
    usagePage: {
      label: "Usage",
      title: "Review your plan and generation usage",
      description: "Track today's usage, remaining generations, and subscription state from one place.",
      accountCard: "Account status",
      memberSince: "Member since",
      subscriptionStatus: "Subscription status",
      active: "Active",
      inactive: "Inactive",
      billingCard: "Manage plan",
      billingBody: "Upgrades, billing history, and portal access stay on the pricing page.",
      billingCta: "View pricing"
    },
    settingsPage: {
      label: "Settings",
      title: "Manage your workspace preferences",
      description: "Review language, theme, and account information from one place.",
      appearance: "Appearance and language",
      appearanceBody: "You can change the interface language and theme at any time.",
      account: "Account",
      accountBody: "Review the current signed-in account and plan.",
      billingBody: "Billing changes and plan upgrades stay on the pricing page.",
      billingCta: "Manage pricing"
    }
  },
  history: {
    label: "History",
...
const ko = {
  ...
  hero: {
    ...
    description:
      "VertikerAI은 솔로 개발자가 구조화된 AI 워크플로우, 프롬프트 템플릿, 스트리밍 응답, 생성 기록을 통해 콘셉트에서 플레이 가능한 MVP까지 빠르게 이동하도록 돕습니다.",
    viewPricing: "요금제 보기",
    liveOutput: "실시간 출력",
    streaming: "스트리밍",
    ...
    highlights: [
      {
        title: "아이디어 생성",
        description: "장르, 플랫폼, 테마를 루프와 수익화가 포함된 게임 콘셉트로 전환합니다."
      },
      {
        title: "UI 방향성",
  ...
  toolCards: {
    ...
    items: [
      {
        title: "게임 아이디어 생성기",
        description: "장르, 플랫폼, 테마를 시장성 있는 콘셉트로 구체화합니다."
      },
      {
        title: "게임 UI 생성기",
  ...
  dashboard: {
    ...
    usagePage: {
      label: "사용량",
      title: "플랜과 생성 사용량을 확인하세요",
      description: "오늘 사용량, 남은 생성 횟수, 구독 상태를 한 화면에서 확인할 수 있습니다.",
      accountCard: "계정 상태",
      memberSince: "가입일",
      ...
      inactive: "비활성",
      billingCard: "플랜 관리",
      billingBody: "업그레이드, 결제 내역, 포털 이동은 요금제 페이지에서 관리할 수 있습니다.",
      billingCta: "요금제 보기"
    },
    settingsPage: {
      label: "설정",
      title: "워크스페이스 환경을 관리하세요",
      description: "언어, 테마, 계정 정보를 한 곳에서 확인하고 변경할 수 있습니다.",
      appearance: "표시 및 언어",
      appearanceBody: "인터페이스 언어와 테마는 언제든지 바꿀 수 있습니다.",
      account: "계정",
      accountBody: "현재 로그인한 계정과 플랜 정보를 확인하세요.",
      billingBody: "결제 변경과 플랜 업그레이드는 요금제 페이지에서 관리합니다.",
      billingCta: "요금제 관리"
    }
  },
  history: {
  ...
  auth: {
    ...
    signOutFallbackError: "로컬에서는 로그아웃되었지만 원격 세션을 완전히 종료하지 못했습니다.",
    callbackFailed: "인증 콜백에 실패했습니다. 다시 로그인해 주세요.",
    missingCallbackCode: "인증 콜백에 코드가 없습니다."
  },
  languageSelector: {
    english: "English",
    korean: "한국어"
  ...
  tools: {
    ...
    ideaDescription: "다음 게임을 위한 상위 수준의 콘셉트, 게임플레이 루프, 수익화 모델, UI 레이아웃을 생성합니다.",
    uiTitle: "게임 UI 생성기",
